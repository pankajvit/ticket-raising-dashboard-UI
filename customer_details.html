...
<head>
    ...
    <!-- Title Page-->
    <title>Customer Details Board</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#home">Customer Data</a></li>
                            <li><a data-toggle="tab" href="#menu1">Customer Operations</a></li>
                        </ul>
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active">
                                <h3 class="title-5 m-b-35">Customer Data</h3>
                            ...
                            <div id="menu1" class="tab-pane fade">
                                <h3 class="title-5 m-b-35">Customer Data Opeations</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                    ...
                                    <table class="table table-data2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Total Tickets</th>
                                                <th>Payment</th>
                                                <th class="text-rigt">Operations</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="tr-shadow">
